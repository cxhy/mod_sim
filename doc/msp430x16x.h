...
#define DMA3TSEL0           (0x1000u)    /* DMA channel 3 transfer select bit 0 */
#define DMA3TSEL1           (0x2000u)    /* DMA channel 3 transfer select bit 1 */
#define DMA3TSEL2           (0x4000u)    /* DMA channel 3 transfer select bit 2 */
#define DMA3TSEL3           (0x8000u)    /* DMA channel 3 transfer select bit 3 */
...
#define DMA3TSEL_0          (0*0x0100u)  /* DMA channel 3 transfer select 0:  DMA_REQ */
#define DMA3TSEL_1          (1*0x0100u)  /* DMA channel 3 transfer select 1:  Timer_A CCRIFG.2 */
#define DMA3TSEL_2          (2*0x0100u)  /* DMA channel 3 transfer select 2:  Timer_B CCRIFG.2 */
#define DMA3TSEL_3          (3*0x0100u)  /* DMA channel 3 transfer select 3:  UART0/I2C receive */
#define DMA3TSEL_4          (4*0x0100u)  /* DMA channel 3 transfer select 4:  UART0/I2C transmit */
#define DMA3TSEL_5          (5*0x0100u)  /* DMA channel 3 transfer select 5:  DAC12.0IFG */
#define DMA3TSEL_6          (6*0x0100u)  /* DMA channel 3 transfer select 6:  ADC12 (ADC12IFG) */
#define DMA3TSEL_7          (7*0x0100u)  /* DMA channel 3 transfer select 7:  Timer_A (TACCR0.IFG) */
#define DMA3TSEL_8          (8*0x0100u)  /* DMA channel 3 transfer select 8:  Timer_B (TBCCR0.IFG) */
#define DMA3TSEL_9          (9*0x0100u)  /* DMA channel 3 transfer select 9:  UART1 receive */
#define DMA3TSEL_10         (10*0x0100u) /* DMA channel 3 transfer select 10: UART1 transmit */
#define DMA3TSEL_11         (11*0x0100u) /* DMA channel 3 transfer select 11: Multiplier ready */
#define DMA3TSEL_14         (14*0x0100u) /* DMA channel 3 transfer select 14: previous DMA channel DMA1IFG */
#define DMA3TSEL_15         (15*0x0100u) /* DMA channel 3 transfer select 15: ext. Trigger (DMAE0) */
...
#define DMA4TSEL0           (0x1000u)    /* DMA channel 4 transfer select bit 0 */
#define DMA4TSEL1           (0x2000u)    /* DMA channel 4 transfer select bit 1 */
#define DMA4TSEL2           (0x4000u)    /* DMA channel 4 transfer select bit 2 */
#define DMA4TSEL3           (0x8000u)    /* DMA channel 4 transfer select bit 3 */

#define DMA3TSEL_0          (0*0x0100u)  /* DMA channel 4 transfer select 0:  DMA_REQ */
#define DMA3TSEL_1          (1*0x0100u)  /* DMA channel 4 transfer select 1:  Timer_A CCRIFG.2 */
#define DMA3TSEL_2          (2*0x0100u)  /* DMA channel 4 transfer select 2:  Timer_B CCRIFG.2 */
#define DMA3TSEL_3          (3*0x0100u)  /* DMA channel 4 transfer select 3:  UART0/I2C receive */
#define DMA3TSEL_4          (4*0x0100u)  /* DMA channel 4 transfer select 4:  UART0/I2C transmit */
#define DMA3TSEL_5          (5*0x0100u)  /* DMA channel 4 transfer select 5:  DAC12.0IFG */
#define DMA3TSEL_6          (6*0x0100u)  /* DMA channel 4 transfer select 6:  ADC12 (ADC12IFG) */
#define DMA3TSEL_7          (7*0x0100u)  /* DMA channel 4 transfer select 7:  Timer_A (TACCR0.IFG) */
#define DMA3TSEL_8          (8*0x0100u)  /* DMA channel 4 transfer select 8:  Timer_B (TBCCR0.IFG) */
#define DMA3TSEL_9          (9*0x0100u)  /* DMA channel 4 transfer select 9:  UART1 receive */
#define DMA3TSEL_10         (10*0x0100u) /* DMA channel 4 transfer select 10: UART1 transmit */
#define DMA3TSEL_11         (11*0x0100u) /* DMA channel 4 transfer select 11: Multiplier ready */
#define DMA3TSEL_14         (14*0x0100u) /* DMA channel 4 transfer select 14: previous DMA channel DMA1IFG */
#define DMA3TSEL_15         (15*0x0100u) /* DMA channel 4 transfer select 15: ext. Trigger (DMAE0) */
...
DEFW(   DMA2SZ            , DMA2SZ_)
/************************************************************
* Extera DMA channal (offset from 0x01CE)
************************************************************/
#define DMA3CTL_            (0x01d8u)    /* DMA Channel 3 Control */
DEFW(   DMA2CTL           , DMA2CTL_)
#define DMA4CTL_            (0x01d0u)    /* DMA Channel 4 Control */
DEFW(   DMA2CTL           , DMA2CTL_)

#define DMA3SA_             (0x01dau)    /* DMA Channel 3 Source Address */
DEFW(   DMA3SA            , DMA3SA_)
#define DMA3DA_             (0x01dcu)    /* DMA Channel 3 Destination Address */
DEFW(   DMA3DA            , DMA3DA_)
#define DMA3SZ_             (0x01deu)    /* DMA Channel 3 Transfer Size */
DEFW(   DMA3SZ            , DMA3SZ_)

#define DMA4SA_             (0x01d2u)    /* DMA Channel 4 Source Address */
DEFW(   DMA4SA            , DMA4SA_)
#define DMA4DA_             (0x01d4u)    /* DMA Channel 4 Destination Address */
DEFW(   DMA4DA            , DMA4DA_)
#define DMA4SZ_             (0x01d6u)    /* DMA Channel 4 Transfer Size */
DEFW(   DMA4SZ            , DMA4SZ_)
